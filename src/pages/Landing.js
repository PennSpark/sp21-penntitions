    ...
    <div className="flex flex-col overflow-x-hidden">
      ...
      <div className="w-screen flex justify-around items-center my-8">
        <div className="flex flex-col justify-center items-start w-1/3 space-y-6">
          ...
          <button className="bg-blue-700 text-white font-bold text-2xl rounded-full px-10 py-4 self-center transition hover:bg-blue-400"><Link to='/signup'>Sign up now!</Link></button>
        </div>
